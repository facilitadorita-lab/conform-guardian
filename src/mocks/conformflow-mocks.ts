...
export const masterEmpresas = [
  {
    id: "EMP-001",
    razao: "Clínica Vitalis Ltda.",
    fantasia: "Clínica Vitalis",
    cnpj: "12.345.678/0001-90",
    plano: "Professional",
  ...
  {
    id: "EMP-002",
    razao: "LabAnalytics S.A.",
    fantasia: "LabAnalytics",
    cnpj: "22.981.221/0001-05",
    plano: "Enterprise",
    status: "ativa" as EmpresaStatus,
    usuarios: 48,
    documentos: 132,
  ...
  {
    id: "EMP-003",
    razao: "Farma+ Distribuidora",
    fantasia: "Farma+",
    cnpj: "33.117.008/0001-71",
    plano: "Starter",
    status: "inadimplente" as EmpresaStatus,
    usuarios: 3,
    documentos: 14,
    equipamentos: 6,
    assinatura: "atrasada",
  ...
  {
    id: "EMP-004",
    razao: "Hospital São Bento",
    fantasia: "Hosp. São Bento",
    cnpj: "44.220.100/0001-33",
    plano: "Enterprise",
    status: "ativa" as EmpresaStatus,
    usuarios: 92,
    documentos: 214,
  ...
  },
  {
    id: "EMP-005",
    razao: "Odonto Prime",
    fantasia: "Odonto Prime",
    cnpj: "55.802.441/0001-12",
    plano: "Starter",
    status: "suspensa" as EmpresaStatus,
    usuarios: 5,
    documentos: 12,
    equipamentos: 4,
    assinatura: "suspensa",
  ...
  {
    id: "EMP-006",
    razao: "BioQuímica Sul",
    fantasia: "BioQuímica Sul",
    cnpj: "66.311.980/0001-09",
    plano: "Professional",
    status: "ativa" as EmpresaStatus,
    usuarios: 22,
    documentos: 63,
...
export const masterAssinaturas = [
  {
    id: "AS-9001",
    empresa: "Clínica Vitalis Ltda.",
    plano: "Professional",
    inicio: "2024-05-11",
    proximaCobranca: "2026-08-10",
    valor: 349,
    status: "ativa",
  },
  {
    id: "AS-9002",
    empresa: "LabAnalytics S.A.",
    plano: "Enterprise",
    inicio: "2023-11-02",
  ...
  {
    id: "AS-9003",
    empresa: "Farma+ Distribuidora",
    plano: "Starter",
    inicio: "2025-01-19",
    proximaCobranca: "2026-07-19",
    valor: 149,
    status: "atrasada",
  },
  {
    id: "AS-9004",
    empresa: "Hospital São Bento",
    plano: "Enterprise",
    inicio: "2022-08-30",
    proximaCobranca: "2026-08-30",
    valor: 899,
    status: "ativa",
  },
  {
...
export const masterInadimplentes = [
  ...
  },
  {
    ...
    valor: 149,
    diasAtraso: 38,
    ultimaTentativa: "2026-07-04",
  },
  {
    empresa: "TechDiag Imagem",
    plano: "Professional",
    valor: 349,
    diasAtraso: 4,
    ultimaTentativa: "2026-07-10",
  },
];
...
export const pendenciasCriticas = [
  {
    id: "P-2041",
    item: "Alvará Sanitário 2025",
    tipo: "Documento",
    responsavel: "Marina Alves",
    vencimento: "2026-07-06",
    diasRestantes: 2,
    status: "critico" as StatusVenc,
  },
  {
    id: "P-2039",
    item: "Calibração Balança BL-04",
    tipo: "Equipamento",
    responsavel: "Rafael Souza",
    vencimento: "2026-07-02",
    diasRestantes: -2,
    status: "vencido" as StatusVenc,
  },
  {
    id: "P-2037",
    item: "Manutenção Preventiva Autoclave AC-01",
    tipo: "Manutenção",
  ...
  },
  {
    ...
    diasRestantes: 11,
    status: "atencao" as StatusVenc,
  },
  {
    id: "P-2033",
    item: "Qualificação Câmara Fria CF-02",
    tipo: "Equipamento",
  ...
  {
    id: "P-2031",
    item: "Contrato Coleta Resíduos",
    tipo: "Documento",
    responsavel: "Marina Alves",
    vencimento: "2026-08-05",
    diasRestantes: 32,
    status: "ok" as StatusVenc,
  },
  {
    id: "P-2029",
    item: "Manutenção Corretiva Ar-Cond. AR-08",
    tipo: "Manutenção",
    responsavel: "Rafael Souza",
...
export const documentos = [
  ...
  {
    id: "D-104",
    nome: "Contrato Coleta de Resíduos",
    categoria: "Contratos",
    tipo: "Contrato",
    numero: "CT-0071",
    orgao: "EcoAmbiental",
  ...
  {
    id: "D-106",
    nome: "Certificado de Boas Práticas",
    categoria: "Qualidade",
    tipo: "Certificado",
    numero: "BPF-221",
    orgao: "ANVISA",
...
export const manutencoes = [
  ...
  },
  {
    ...
    data: "2026-07-30",
    responsavel: "Higienização Total",
    status: "ok" as StatusVenc,
    os: "OS-8830",
  },
  {
    id: "M-504",
    equipamento: "Câmara Fria CF-02",
    tipo: "Preventiva",
    data: "2026-08-05",
    responsavel: "ColdMax",
    status: "ok" as StatusVenc,
...
export const alertas = [
  ...
  },
  {
    id: "A-9002",
    marco: "30 dias",
    item: "Licença Ambiental LO-4488",
    canal: "Central",
    data: "2026-07-10",
    nivel: "info",
  },
...
export const auditoriaLogs = [
  ...
  },
  {
    ...
    entidade: "Usuário camila.torres",
    ip: "10.0.0.4",
  },
  {
    id: "L-77018",
