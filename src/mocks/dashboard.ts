...
export const pendenciasMock: PendenciaResumo[] = [
  ...
  {
    id: "P-2037",
    item: "Manutencao Preventiva Autoclave AC-01",
    tipo: "Manutencao",
    responsavel: "Time Tecnico",
  ...
  {
    id: "P-2033",
    item: "Qualificacao Camara Fria CF-02",
    tipo: "Equipamento",
  ...
  {
    id: "P-2029",
    item: "Manutencao Corretiva Ar-Cond. AR-08",
    tipo: "Manutencao",
    responsavel: "Rafael Souza",
