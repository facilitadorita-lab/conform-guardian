...
export const documentosMock: DocumentoResumo[] = [
  {
    id: "D-101",
    nome: "Alvara Sanitario 2025",
    categoria: "Regulatorio",
    tipo: "Alvara",
    numero: "AS-2025-0091",
    orgao: "Vigilancia Sanitaria",
  ...
  {
    id: "D-102",
    nome: "Licenca Ambiental de Operacao",
    categoria: "Ambiental",
    tipo: "Licenca",
    numero: "LO-4488",
    orgao: "SEMA",
  ...
  {
    id: "D-104",
    nome: "Contrato Coleta de Residuos",
    categoria: "Contratos",
    tipo: "Contrato",
    numero: "CT-0071",
    orgao: "EcoAmbiental",
  ...
  {
    id: "D-106",
    nome: "Certificado de Boas Praticas",
    categoria: "Qualidade",
    tipo: "Certificado",
    numero: "BPF-221",
    orgao: "ANVISA",
